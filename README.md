...
- [runStat.m] (https://github.com/rb643/dti/blob/master/runStat.m), this runs some statistics on the output you would get from running dti.m. You can specify which output you want and which metric. Currently only runs a standard ANOVA + post-hoc permutation on global metrics.
